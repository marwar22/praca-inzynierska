...
<template>
  <div class="container__margin flex flex-col">
    ...
    <div class="flex h-12 items-center">
      ...
      <NuxtLink
        to="/rozgrywki/utworz"
        class="bg-champagne-500 ring-champagne-800 hover:bg-champagne-600 active:bg-champagne-700 my-1 flex h-full items-center justify-center rounded-lg px-4 py-1 text-lg font-bold text-white outline-none focus-visible:ring-2"
      >
        Utwórz rozgrywkę
      </NuxtLink>
    </div>
    ...
    >
      <div class="flex flex-col">
        <div>
          <h2 class="inline-block text-lg font-bold">{{ league }}</h2>
        </div>
        <div><font-awesome-icon icon="fa-solid fa-calendar-days" /> 07.11.2023 - 07.12.2023</div>
      </div>
      <div><font-awesome-icon icon="fa-solid fa-users" />16</div>
    </button>
  </div>
</template>
