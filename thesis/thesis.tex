...
Ten rozdział opisuje interfejs aplikacji pozwalając użytkownikowi zapoznać się z nim.
...
Strona główna dostarcza użytkownikowi ogólne informacje, co oferuje aplikacja webowa oraz umożliwia przejscie do różnych części projektu poprzez linki w pasku nawigacyjnym i wyeksponowane przyciski.
\begin{figure}[H]
    \centering
...
Test polegał na załadowaniu strony z rozgrywkami.
\begin{figure}[H]
    \centering
